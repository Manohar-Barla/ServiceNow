"""
Django settings for servicenow_csa project.
...
SECRET_KEY = 'django-insecure-fa&&nk(k2r0!qr#y&0!pbdr3ksv()yumn&673o@l3!qx9s@tul'
...
WSGI_APPLICATION = 'servicenow_csa.wsgi.application'
